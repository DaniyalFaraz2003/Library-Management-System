<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="homepage.aspx.cs" Inherits="Gym_Website_DB_Project.homepage" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <%--this is the content for the head content placeholder in the master page--%>
    <%--basically for all the custom css for this page and the js for this page--%>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <%--this is the content for the body content placeholder in the master page--%>
    <section>
